...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
  ...
  */
  ...
  PredictLidarMeasurement(&S, &z_pred);
  UpdateLidarState(S, z_pred, meas_package);
}
...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
  ...
  */
  ...
  PredictRadarMeasurement(&S, &z_pred);
  UpdateRadarState(S, z_pred, meas_package);
}
...
void UKF::PredictRadarMeasurement(MatrixXd* S_out, VectorXd* z_out)
{
...
void UKF::PredictLidarMeasurement(MatrixXd* S_out, VectorXd* z_out)
{
  //transform sigma points into measurement space
  for (int i = 0; i < 2 * n_aug_ + 1; i++)
  {
...
void UKF::UpdateLidarState(MatrixXd S, VectorXd z_pred, MeasurementPackage meas_package)
{
...
void UKF::UpdateRadarState(MatrixXd S, VectorXd z_pred, MeasurementPackage meas_package)
{
  //create matrix for cross correlation Tc
